...
var _class = function (_think$model$relation) {
  ...
  _class.prototype.getPostList = function () {
    var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(page) {
      ...
      var field, _getWhereCondition, name, _ref4, id, _where, where;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 15:
              ...
              return _context2.abrupt('return', this.join({
                table: 'post_' + name,
                as: name,
                on: ['id', 'post_id']
            ...
            case 17:
              ...
              return _context2.abrupt('return', this.field(field).page(page, this.postsListSize).setRelation('user').order('create_time DESC').where(where).countSelect());
  ...
  _class.prototype.getPostDetail = function () {
    var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(pathname) {
      var where, detail, createTime, prevWhere, prevPromise, nextWhere, nextPromise, _ref6, prev, next;
  ...
  _class.prototype.getPostSearch = function () {
    var _ref10 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(keyword, page) {
      var where;
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              return _context7.abrupt('return', this.where(where).page(page, this.postsListSize).setRelation(false).field('title,pathname,summary,create_time').order('create_time DESC').countSelect());
