...
var _class = function (_Base) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 10:
              ...
              field = ['id', 'title', 'user_id', 'create_time', 'update_time', 'status', 'pathname', 'is_public'];
              _context.next = 17;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 10:
              ...
              _context2.next = 13;
              return this.getContentAndSummary(data);
  ...
  _class.prototype.pushPost = function () {
    var _ref5 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(post) {
      var postOpt, canPush, options, push_sites, push_sites_keys, site_url, pushes, result;
  ...
  _class.prototype.getContentAndSummary = function () {
    var _ref7 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(data) {
      var options, postTocManual, showToc;
    ...
    function getContentAndSummary(_x3) {
  ...
  _class.prototype.getTagIds = function () {
    var _ref8 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8(tags) {
