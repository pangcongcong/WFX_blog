        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 8:
              ...
              return _context2.abrupt('return', (0, _child_process.exec)('npm install --registry=' + registry, function (error, stdout, stderr) {
                if (error) {
                  _this2.fail(error);
                }
