        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              basename = (name ? name : think.md5(result.body)) + _path2.default.extname(url);
              ...
              _context.next = 11;
              return putFileContent(_path2.default.join(destPath, basename), result.body, 'binary');

            case 11:
              result = _context.sent;
              return _context.abrupt('return', _path2.default.join('/static/upload', destDir, basename));
